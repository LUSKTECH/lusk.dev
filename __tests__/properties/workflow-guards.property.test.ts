 ...
 */
const WORKFLOW_SECRET_PAIRS: Array<{
  workflow: string;
  secret: string;
  guardPattern: string;
}> = [
  // security.yml
  {
    ...
    secret: 'TRIVY_ENABLED',
    guardPattern: 'vars.TRIVY_ENABLED',
  },
  {
    workflow: 'security.yml',
    secret: 'SNYK_TOKEN',
    guardPattern: 'secrets.SNYK_TOKEN',
  },
  {
    workflow: 'security.yml',
    secret: 'SAFETY_API_KEY',
    guardPattern: 'secrets.SAFETY_API_KEY',
  },
  // lighthouse.yml
  {
    workflow: 'lighthouse.yml',
    secret: 'LHCI_GITHUB_APP_TOKEN',
    guardPattern: 'secrets.LHCI_GITHUB_APP_TOKEN',
  },
  // deploy-preview.yml
  {
    workflow: 'deploy-preview.yml',
    secret: 'VERCEL_TOKEN',
    guardPattern: 'secrets.VERCEL_TOKEN',
  },
  {
    workflow: 'deploy-preview.yml',
    secret: 'NETLIFY_AUTH_TOKEN',
    guardPattern: 'secrets.NETLIFY_AUTH_TOKEN',
  },
  ...
  // sonarqube.yml
  {
    ...
    secret: 'SONAR_TOKEN',
    guardPattern: 'secrets.SONAR_TOKEN',
  },
  // qlty.yml
  {
    workflow: 'qlty.yml',
  ...
  // ci.yml (step-level guard)
  {
    ...
    guardPattern: 'secrets.CODECOV_TOKEN',
  },
];
  ...
  it('should contain an if conditional checking for each guarded secret', () => {
    fc.assert(
      fc.property(
        ...
        ({ workflow, secret: _secret, guardPattern }) => {
