...
export default function CookiePreferences({
  ...
  const [region, setRegion] = useState<CookieConsentState["region"]>("general");
    ...
    <section aria-label="Cookie preferences" style={containerStyle}>
      ...
      <div style={categoryStyle}>
        <div style={labelStyle}>
          ...
          <span style={descStyle}>Help us understand how visitors use the site.</span>
        </div>
        <input
          type="checkbox"
          checked={analytics}
      ...
      <div style={categoryStyle}>
        <div style={labelStyle}>
          ...
          <span style={descStyle}>Used to deliver relevant advertisements.</span>
        </div>
        <input
          type="checkbox"
          checked={marketing}
