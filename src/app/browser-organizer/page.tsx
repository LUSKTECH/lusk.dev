    ...
    <>
      ...
      <main>
        ...
        <section className="hero">
          ...
          <div className="hero-inner">
            ...
            <p className="hero-desc">
              ...
              key, so your tabs only ever reach the provider you already pay
              for. Review every change, or let it run on a schedule with
              one-click undo.
            </p>
        ...
        <section className="section" id="features">
          ...
          <div className="featured-project">
            ...
            <p className="desc">
              ...
              flagged to close or suspend, and anything worth keeping is
              bookmarked first.
            </p>
            <div className="featured-features">
              <span className="feature-chip">Group by topic</span>
              <span className="feature-chip">Close stale tabs</span>
              <span className="feature-chip">Suspend, don&apos;t lose</span>
              <span className="feature-chip">Bookmark the keepers</span>
              <span className="feature-chip">One-click undo</span>
            </div>
            <a
              href={REPO}
              target="_blank"
          ...
          <div className="projects-grid">
            <div className="project-card">
              ...
              <h3>Tidy bookmarks</h3>
              <p className="card-desc">
                Finds duplicate, stale, and dead bookmarks, with an optional
                link check, and files the useful ones into clean folders.
              </p>
            </div>
            ...
            <div className="project-card">
              ...
              <p className="card-desc">
                Scheduled auto-mode runs quietly in the background. Every action
                is logged so a single click undoes it.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section" id="backends">
          ...
          <p className="section-desc">
            No accounts with us, no servers we run. Point it at a local AI CLI
            or any OpenAI-compatible endpoint. Your tab titles and URLs go only
            to the provider you choose; bookmarks and history never leave your
            machine.
          </p>
          ...
          <ol className="bo-steps">
            <li className="bo-step">
              ...
              <div>
                ...
                <p>
                  Add Browser Organizer to Chrome or Edge (unpacked today,
                  one-click from the stores soon).
                </p>
              </div>
            </li>
            <li className="bo-step">
