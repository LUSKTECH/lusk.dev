      ...
      <main>
        ...
        <section className="hero" id="home">
          ...
          <div className="hero-inner">
            <div className="hero-badge">
              <span aria-hidden="true">⚡</span> Open source &middot; Always
              free
            </div>
            <h1>
        ...
        <section className="section" id="projects">
          ...
          <h2 className="section-heading">
            Bulk Plugin Installer for WordPress
          </h2>
          <p className="section-desc">
            The one that started it all. Upload a stack of plugin ZIPs and
            install them in one shot — with preview, rollback, and profile
            support baked in.
          </p>
          ...
          <div className="projects-grid">
            ...
            >
              ...
              <p className="card-desc">
                ...
                Deploy apps, manage listings, and check vitals — all from your
                AI coding assistant.
              </p>
